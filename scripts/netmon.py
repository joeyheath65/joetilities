...
print("        ********************************************************************\n"
      ...
      "        **                                                                **\n"
      "        **         This Joetility is the Network Connect Monitor          **\n"
      "        **                                                                **\n"
      "        ********************************************************************\n")
print()
# since you're forgetful, add this note to each script tellling what it does bruh
print("        ******                --> USAGE  NOTE <--                     ******\n"
      "        * This Joetility will monitor connection to a single endpoint and  *\n"
      "        *  report if there are any periods of disconnect and for how long. *\n"
      "		   *  The results will also be saved in a file called netinfo.log...  *\n"
      "        ********************************************************************\n")
